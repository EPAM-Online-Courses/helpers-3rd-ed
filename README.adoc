...
IMPORTANT: The main package for these solutions should be `com.epam.prd.jjop.helpers`.
...
+
. Create a Pull Request to merge it to `EPAM-Online-Courses/helpers-3rd-ed:master`.
